...
using IEADPC.Shell.Services.Extentions;
...
namespace IEADPC.Shell.Services
{
    public class VisualModuleManager : IVisualModuleManager
    {
        ...
        /// </summary>
        /// <returns>All found <see cref="IVisualServiceMetadata"/></returns>
        ...
        /// </summary>
        /// <typeparam name="T">Your <see cref="IVisualService"/></typeparam>
        /// <returns></returns>
